      ...
      <div class="row justify-content-center">
        <div class="input-group input-group-icon col col-12" v-if="!show">
          ...
          <input
            ...
            class="form-control default-account"
            placeholder="Your Ethereum Address"
          >
          <button class="btn" v-on:click="submit">Submit</button>
        </div>
        <h3 style="margin-top: 5%;" v-if="!show">
          Or Please open your MetaMask and unlock it, then
          <strong>
            <u class="click-me" v-on:click="metaMaskInit()">Click Me</u>
          </strong> To Submit Your Ethereum
        </h3>
        <div class="input-group input-group-icon col col-12" v-if="show">
          <div class="input-group-prepend">
            <span class="input-group-text modal-input-txt">Your Ethereum is</span>
...
module.exports = {
  ...
  methods: {
    ...
    submit() {
      ...
      this.$http.post("/submit-ethereum", data, headers).then(
        function(response) {
